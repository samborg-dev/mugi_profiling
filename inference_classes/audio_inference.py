...
class AudioModel(InferenceModel):
    ...
    def load_model(self):
        ...
        self.model = AutoModelForSpeechSeq2Seq.from_pretrained(self.model_name, torch_dtype=torch.float16, attn_implementation='eager', device_map='auto').to(self.device)
